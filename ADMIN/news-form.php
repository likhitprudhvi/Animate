...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["image"])) {
    ...
    $targetDir = "../uploads/news0/"; // Folder to store uploaded images
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
        $imagepath = $targetFile; // Store uploaded image path
    } else {
    ...
    $checkNewsStmt = $conn->prepare("SELECT heading FROM newsform WHERE heading = ?");
    $checkNewsStmt->bind_param("s", $heading);
    ...
    if ($checkNewsStmt->num_rows > 0) {
        ...
        // Prepare and bind
        $stmt = $conn->prepare("INSERT INTO newsform (date, imagepath, heading, description) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $date, $imagepath, $heading, $description);
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">News forms</h4>
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Fill the news details below</div>
									</div>
									<div class="card-body">
