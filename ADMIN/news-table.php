	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="main-panel">
				<div class="content">
					<div class="container-fluid">
						<h4 class="page-title">News tables</h4>
						<div class="row">
							<div class="col-md-12">
									...
									<div class="card-body">
										...
										<table class="table table-bordered" id = "table">
											...
											if(isset($_POST['id'])) {
												...
												$deleteQuery = "DELETE FROM newsform WHERE id = ?";
												...
												if (mysqli_stmt_execute($stmt)) {
													...
													mysqli_query($conn, "UPDATE newsform SET id = @count:= @count + 1");
													mysqli_query($conn, "ALTER TABLE newsform AUTO_INCREMENT = 1");
												}
										...
										$myusers = "SELECT * FROM newsform";
										$usercon = mysqli_query($conn,$myusers);
										while($newsdata = mysqli_fetch_assoc($usercon)) 
										{ 
											?>
											...
											<tbody>
												<tr>
													...
													<td><?php echo $newsdata['date'];?></td>
													<td><?php echo $newsdata['heading'];?></td>
													<td><?php echo $newsdata['description'];?></td>
													<td><?php echo $newsdata['imagepath'];?></td>
													<td>
