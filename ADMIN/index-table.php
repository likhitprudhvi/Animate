						...
						<div class="row">
							<div class="col-md-12">
									...
									<div class="card-body">
										...
										<table class="table table-bordered" id="table_0">
											...
											if(isset($_POST['id0'])) {
												...
												$deleteQuery = "DELETE FROM indexform0 WHERE id0 = ?";
												...
												if (mysqli_stmt_execute($stmt)) {
													...
													mysqli_query($conn, "UPDATE indexform0 SET id0 = @count:= @count + 1");
													mysqli_query($conn, "ALTER TABLE indexform0 AUTO_INCREMENT = 1");
												}
												
											} else {
												echo "Invalid request!";
											}
										$myusers = "SELECT * FROM indexform0";
										$usercon = mysqli_query($conn,$myusers);
										while($indexdata = mysqli_fetch_assoc($usercon)) 
										{ 
											?>

											<tbody>
												<tr>
													<td><?php echo $indexdata['id0'];?></td>
													<td><?php echo $indexdata['date0'];?></td>
													<td><?php echo $indexdata['heading0'];?></td>
													<td><?php echo $indexdata['description0'];?></td>
													<td><?php echo $indexdata['imagepath0'];?></td>
													<td>
														<form method="POST" onsubmit="return confirmDelete()">
															<input type="hidden" name="id0" value="<?php echo $indexdata['id0']; ?>">
									...
									<div class="card-body">
										...
										<table class="table table-bordered" id="table_1">
											...
											if(isset($_POST['id1'])) {
												...
												$deleteQuery = "DELETE FROM indexform1 WHERE id1 = ?";
												$stmt = mysqli_prepare($conn, $deleteQuery);
												...
												if (mysqli_stmt_execute($stmt)) {
													// Rearrange the ID sequence
													mysqli_query($conn, "SET @count = 0");
													mysqli_query($conn, "UPDATE indexform1 SET id1 = @count:= @count + 1");
													mysqli_query($conn, "ALTER TABLE indexform1 AUTO_INCREMENT = 1");
												}
												
											} else {
												echo "Invalid request!";
											}
										$myusers = "SELECT * FROM indexform1";
										$usercon = mysqli_query($conn,$myusers);
										while($indexdata = mysqli_fetch_assoc($usercon)) 
										{ 
											?>
											...
											<tbody>
												<tr>
													<td><?php echo $indexdata['id1'];?></td>
													<td><?php echo $indexdata['date1'];?></td>
													<td><?php echo $indexdata['heading1'];?></td>
													<td><?php echo $indexdata['description1'];?></td>
													<td><?php echo $indexdata['imagepath1'];?></td>
													<td>
														<form method="POST" onsubmit="return confirmDelete()">
															<input type="hidden" name="id1" value="<?php echo $indexdata['id1']; ?>">
															<button type="submit" class="btn btn-danger">Remove</button>
														</form>
													</td>
								...
								<div class="card">
									<div class="card-body">
										<div class="card-sub">
											Details of featured news section
										</div>
										<table class="table table-bordered" id="table_2">
											...
											if(isset($_POST['id2'])) {
												...
												$deleteQuery = "DELETE FROM indexform2 WHERE id2 = ?";
												$stmt = mysqli_prepare($conn, $deleteQuery);
												...
												if (mysqli_stmt_execute($stmt)) {
													// Rearrange the ID sequence
													mysqli_query($conn, "SET @count = 0");
													mysqli_query($conn, "UPDATE indexform2 SET id2 = @count:= @count + 1");
													mysqli_query($conn, "ALTER TABLE indexform2 AUTO_INCREMENT = 1");
												}
												
											} else {
												echo "Invalid request!";
											}
										$myusers = "SELECT * FROM indexform2";
										$usercon = mysqli_query($conn,$myusers);
										while($indexdata = mysqli_fetch_assoc($usercon)) 
										{ 
											?>
											...
											<tbody>
												<tr>
													<td><?php echo $indexdata['id2'];?></td>
													<td><?php echo $indexdata['date2'];?></td>
													<td><?php echo $indexdata['heading2'];?></td>
													<td><?php echo $indexdata['description2'];?></td>
													<td><?php echo $indexdata['imagepath2'];?></td>
													<td>
														<form method="POST" onsubmit="return confirmDelete()">
															<input type="hidden" name="id2" value="<?php echo $indexdata['id2']; ?>">
															<button type="submit" class="btn btn-danger">Remove</button>
														</form>
													</td>
									...
									<div class="card-body">
										...
										<table class="table table-bordered" id="table_3">
											...
											if(isset($_POST['id3'])) {
												...
												$deleteQuery = "DELETE FROM indexform3 WHERE id3 = ?";
												$stmt = mysqli_prepare($conn, $deleteQuery);
												mysqli_stmt_bind_param($stmt, "i", $id3);
												
												if (mysqli_stmt_execute($stmt)) {
													// Rearrange the ID sequence
													mysqli_query($conn, "SET @count = 0");
													mysqli_query($conn, "UPDATE indexform3 SET id3 = @count:= @count + 1");
													mysqli_query($conn, "ALTER TABLE indexform3 AUTO_INCREMENT = 1");
												}
												
											} else {
												echo "Invalid request!";
											}
										$myusers = "SELECT * FROM indexform3";
										$usercon = mysqli_query($conn,$myusers);
										while($indexdata = mysqli_fetch_assoc($usercon)) 
										{ 
											?>
											...
											<tbody>
												<tr>
													<td><?php echo $indexdata['id3'];?></td>
													<td><?php echo $indexdata['category3'];?></td>
                                                    <td><?php echo $indexdata['price3'];?></td>
                                                    <td><?php echo $indexdata['rating3'];?></td>
													<td><?php echo $indexdata['heading3'];?></td>
													<td><?php echo $indexdata['description3'];?></td>
													<td><?php echo $indexdata['imagepath3'];?></td>
													<td>
														<form method="POST" onsubmit="return confirmDelete()">
															<input type="hidden" name="id3" value="<?php echo $indexdata['id3']; ?>">
															<button type="submit" class="btn btn-danger">Remove</button>
														</form>
													</td>
									...
									<div class="card-body">
										...
										<table class="table table-bordered" id="table_4">
											...
											if(isset($_POST['id4'])) {
												...
												$deleteQuery = "DELETE FROM indexform4 WHERE id4 = ?";
												$stmt = mysqli_prepare($conn, $deleteQuery);
												...
												if (mysqli_stmt_execute($stmt)) {
													// Rearrange the ID sequence
													mysqli_query($conn, "SET @count = 0");
													mysqli_query($conn, "UPDATE indexform4 SET id4 = @count:= @count + 1");
													mysqli_query($conn, "ALTER TABLE indexform4 AUTO_INCREMENT = 1");
												}
												
											} else {
												echo "Invalid request!";
											}
										$myusers = "SELECT * FROM indexform4";
										$usercon = mysqli_query($conn,$myusers);
										while($indexdata = mysqli_fetch_assoc($usercon)) 
										{ 
											?>
											...
											<tbody>
												<tr>
													<td><?php echo $indexdata['id4'];?></td>
													<td><?php echo $indexdata['category4'];?></td>
                                                    <td><?php echo $indexdata['price4'];?></td>
													<td><?php echo $indexdata['rating4'];?></td>
													<td><?php echo $indexdata['heading4'];?></td>
													<td><?php echo $indexdata['description4'];?></td>
													<td><?php echo $indexdata['imagepath4'];?></td>
													<td>
														<form method="POST" onsubmit="return confirmDelete()">
															<input type="hidden" name="id4" value="<?php echo $indexdata['id4']; ?>">
															<button type="submit" class="btn btn-danger">Remove</button>
														</form>
													</td>
