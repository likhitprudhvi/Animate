            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title mb-0" style="border-left: 0px;">
                        ...
                        <h3 class="m-0 text-dark text-uppercase font-weight-bold">Profile</h3>
                        </div>
                    </div>
                 </div>
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                        ...
                        <?php 
                            ...
                            $shopdata2 = "SELECT * FROM userdata where username = '$name' ";
                            $shopcon2 = $conn->query($shopdata2);

                            if ($shopcon2->num_rows > 0) {
                                $row = $shopcon2->fetch_assoc();
                            ?>
                            <div class="m-0 font-weight-bold" style="padding: 20px;">
                                <div class="text-dark">
                                    <h2>Details </h2><br>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0" style="border-left: 0px;">
                            <div class="m-0 " style="padding: 20px;">
                        <img class="img-fluid w-100" src="img/prof.png" style="height : 300px; width : 700px; margin-left : 17%;">
                    </div>
