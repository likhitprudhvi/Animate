            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title mb-0" style="border-left: 0px;">
                        ...
                        <h3 class="m-0 text-dark text-uppercase font-weight-bold">About</h3>
                        </div>
                    </div>
                 </div>
            ...
            <div class="row">
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0" style="border-left: 0px;">
                            <div class="m-0 text-uppercase font-weight-bold" style="padding: 20px;">
                                <div class="text-dark">
                                    <h2>Animate </h2>
                                    <p>Animate is a dedicated platform for accessing the latest news about Maha Cement while also offering a space to explore its products. With a user-friendly design, the website ensures that industry professionals, builders, and customers stay informed about company updates and cement innovations. In addition to news, users can browse Maha Cement products and learn about their specifications. Whether you are looking for industry insights or product details, Animate provides a seamless experience. Stay informed and explore Maha Cement’s offerings with ease through Animate – your go-to source for news and product information.</p>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-3">
                        <div class="section-title mb-0" style="border-left: 0px;">
                            <div class="m-0 text-uppercase font-weight-bold" style="padding: 20px;">
                        <img class="img-fluid w-100" src="img/qwerty.jpg" style="height : 300px; width : 700px">
                    </div>
