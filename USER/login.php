...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows > 0) {
        $stmt->bind_result($db_password, $username);
        $stmt->fetch();
...
?>
    ...
    <div style="margin-left:30% ;margin-top: 5%;">
        ...
        <form method="post" >
        <div class="section-title mt-5 mb-0" style="border-left:0px;text-align: center;">
        ...
        <div class="bg-white border border-top-0 p-4 mb-3">
            <div class="mb-4">
                <form>
                    ...
                    <div>
                        <button type="submit" class="btn btn-primary font-weight-semi-bold px-4" style="padding:2%;margin-left: 40%;">Login</button>
                    </div>
            </div>
