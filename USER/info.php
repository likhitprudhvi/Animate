    ...
    <div class="container-fluid mt-5 pt-3">
        <div class="container">
            <div class="row text-dark">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <h2><?php echo nl2br(html_entity_decode($row[$col3], ENT_QUOTES, 'UTF-8')); ?></h2>
                    </div>
                    <div class="mb-3">
                        <img class="img-fluid w-100" src="<?php echo htmlspecialchars($row[$col5]); ?>" style="height : 435px; width  : 700px;">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3" style= "padding-left : 5%;">
                        <h4>Details</h4>
                        <p><?php echo nl2br(html_entity_decode($row[$col4], ENT_QUOTES, 'UTF-8')); ?></p>
                    </div>
                </div>
                <?php   
                        }
